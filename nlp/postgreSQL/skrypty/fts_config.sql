...
select * from articles where vector @@ to_tsquery('public.polish', 'and') limit 1;
select count(*) from articles where vector @@ plain_tosquery('public.polish', 'Pozostało znaków: 4000 Zaloguj się Twój podpis');