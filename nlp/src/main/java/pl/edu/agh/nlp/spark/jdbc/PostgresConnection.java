...
public class PostgresConnection implements JdbcRDD.ConnectionFactory {
	...
	private static final String URL = "jdbc:postgresql://127.0.0.1:6543/postgres";// "jdbc:postgresql://127.0.0.1:5432/postgres";
	private static final String LOGIN = "postgres";
	private static final String PASSWORD = "postgres";// "soi";
